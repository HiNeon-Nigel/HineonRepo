<?php
// Template Name: HiNeon HiPatterns
$args = array( 'post_type' => 'product', 'posts_per_page' => 12, 'product_cat' => 'custom-neon-signs', 'orderby' => 'id', 'order' => 'asc', 'offset' => 0 );
$loop = new WP_Query( $args );
get_header(); 

//Dynamic Slider Section
$product_1 = wc_get_product( 12682 );  
$product_2 = wc_get_product( 2673 );  
$product_3 = wc_get_product( 12769 ); 
$product_4 = wc_get_product( 12542 ); 

//Dynamic Deal of the day Section
$product_deal = wc_get_product( 909 );
...
<header class="bg-light _sub_header" style="z-index:999 !important;">
    <div class="container">
        <nav class="secondary-nav navbar navbar-expand-lg navbar-light pl-0 pr-0 bg-light justify-content-between">
            <a class="h3 text-dark" href="#">HiPatterns</a>
            ...
            <div class="collapse navbar-collapse text-uppercase " id="secondaryNav">
                <ul class="navbar-nav ml-auto nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link cool-link active" id="hipatterns-tab" href="<?php echo get_site_url(); ?>/hipatterns/">HiPatterns</a>
                    </li>
					           <li class="nav-item">
                        <a class="nav-link cool-link" id="open-signs-tab" href="<?php echo get_site_url(); ?>/open-sign">Open Signs</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="_tab_content">
          <div id="hipatterns-owl-carousel" class="owl-carousel owl-theme talha">
              ...
              <a href=" <?php echo get_permalink( $product_1->get_id() ); ?> ">
                	<img src="/wp-content/uploads/2020/07/paper-glider-neon-light.jpg" />
              </a>
	...
	<p><a href="<?php echo get_permalink( $product_1->get_id() ); ?> ">
		<?php echo $product_1->get_name(); ?>
              ...
              <a href=" <?php echo get_permalink( $product_2->get_id() ); ?> ">
                <img src="/wp-content/uploads/2020/07/white-Leaf-neon-sign-hand-holdd.jpg" />	
	</a>
                <div class="cust-tiltle-price">
	<p><a href="<?php echo get_permalink( $product_2->get_id() ); ?> ">
		<?php echo $product_2->get_name(); ?>
              ...
              <a href=" <?php echo get_permalink( $product_3->get_id() ); ?> ">
                <img src="/wp-content/uploads/2020/07/moon-bulb.jpg" />
	</a>
                <div class="cust-tiltle-price">
	<p><a href="<?php echo get_permalink( $product_3->get_id() ); ?> ">
		<?php echo $product_3->get_name(); ?>
              ...
              <a href=" <?php echo get_permalink( $product_4->get_id() ); ?> ">
                <img src="/wp-content/uploads/2020/07/moon-light.jpg" />
	</a>
                <div class="cust-tiltle-price">
	...
	<p><a href="<?php echo get_permalink( $product_4->get_id() ); ?> ">
		...
		<div class="cust-search-icon">
            ...
            <div class="text-center cust-load-btn-div">
              ...
              <button type="button" class="load_more" data-offset="1" ><span>Load More</span></button>
...
<div class="container cust-deal-of-day">
			...
			<div class="row">
				<div class="cust-deal-image deal-mob">
					<!--<img src="/wp-content/uploads/2020/07/heart-deal.jpg">-->
					<img src="/wp-content/uploads/2020/08/heart-new.jpg">
				</div>
...
<!--div class="container cyod_section">
	<div class="row">
		...
		<div class="col-md-8 text-center">
			<h4 class="title">Customize Your Own Design</h4>
			<p>Didn't find what you like from above desogns? No worries. We offer full custom<br> design service as well. Fill out the custom inquiry from and our neon specialist will<br> get back to you with free quote and mock up in 24 hours.</p>
			...
			<p class="second_line">*Custom neon sign starts from $500 per order.</p>
			<a href="/hineon-custom/" class="homeslider-btn">Customize Now</a>			
		</div>
	</div>
</div-->
           ...
           <div class="container">
			<div class="row p-5">
              ...
              <div class="col-md-6 text-center">
                <img class="leafi" src="<?php echo get_template_directory_uri(); ?>/images/Leaf.png" />
              </div>
            </div>
            <div class="row p-5 ">
              <div class="col-md-6 text-center cust-mob-hidden">
                <img class="lightbulb" src="<?php echo get_template_directory_uri(); ?>/images/Light-Bulb.png" />
              </div>
              <div class="col-md-6">
