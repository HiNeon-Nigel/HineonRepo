<?php
// Template Name: testing page Open Sign
?>
<?php get_header(); ?>
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="hipatterns" role="tabpanel" aria-labelledby="hipatterns-tab">
        <div class="_tab_content">
          <div id="hipatterns-owl-carousel" class="owl-carousel owl-theme talha">
              <div class="item">
              <a href="https://hineon.com/product/hiletters-shop/open/custom-open/led-open-take-out-neon-sign-for-business-store-flashing-take-out-sign-w-remote-controller/"/>
	...
	<p><a href="https://hineon.com/product/hiletters-shop/open/custom-open/led-open-take-out-neon-sign-for-business-store-flashing-take-out-sign-w-remote-controller/">Open Take Out Sign
              ...
              <div class="item">
                <a href="https://hineon.com/product/hiletters-shop/open/custom-open/large-led-open-neon-signs-big-open-sign/">
                <img src="https://hineon.com/wp-content/uploads/2020/07/open.jpg" />
                <div class="cust-tiltle-price">
	<p><a href="https://hineon.com/product/hiletters-shop/open/custom-open/led-open-neon-sign-for-business-store-ultra-bright-flashing-open-sign-w-remote-controller-cool-white/">Open - White Sign
</a></p>
                <p>$319 - $259</p>
	</div>
              </div>
              <div class="item">
              <a href="https://hineon.com/product/hiletters-shop/open/custom-open/red-open-neon-sign-for-business-store-ultra-bright-flashing-open-sign-w-remote-controller/">
	...
	<p><a href="#">Open - White Sign
              ...
              <a href="https://hineon.com/product/hiletters-shop/open/custom-open/red-open-neon-sign-for-business-store-ultra-bright-flashing-open-sign-w-remote-controller/">
                ...
                <div class="cust-tiltle-price">
	<p><a href="https://hineon.com/product/hiletters-shop/open/custom-open/red-open-neon-sign-for-business-store-ultra-bright-flashing-open-sign-w-remote-controller/">Open - White Sign
</a></p>
                <p>$199</p>
	</div>
              </div>
        ...
        while ( $loop->have_posts() ) : $loop->the_post(); global $product; ?>
            <div class="col-md-4 text-center mb-3 product">  
              ...
              <?php } ?>
                ...
                <!-- code of the open sign -->

                



                <!-- end of code open sign -->
...
<div class="container">
			<h2 class="instatitle">Look Book </h2>
			<div class="row">
