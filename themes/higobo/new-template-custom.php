...
<header class="bg-light _sub_header" style=" z-index:1 !important;">
  ...
  <!--                        <a class="nav-link cool-link not-scroll" id="design_guide-tab" href="<?= get_home_url() ?>/hiletters/#design-guide" role="tab" aria-controls="design_guide" aria-selected="false">Design Guide</a>-->
