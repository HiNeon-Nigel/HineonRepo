...
<!--        </table>-->
        ...
        <h1><?php esc_html_e( 'Footer Options', 'text-domain' ); ?></h1>

        <table class="form-table wpex-custom-admin-login-table">
            <tr valign="top">
                <th scope="row"><?php esc_html_e( 'Footer Button Text', 'text-domain' ); ?></th>
                <td>
                    <?php $value = self::get_theme_option( 'footer-btn-text' ); ?>
                    <input type="text" name="theme_options[footer-btn-text]" value="<?php echo esc_attr( $value ); ?>">
                </td>
            </tr>

            <tr valign="top">
                <th scope="row"><?php esc_html_e( 'Footer Button Link', 'text-domain' ); ?></th>
                <td>
                    <?php $value = self::get_theme_option( 'footer-btn-link' ); ?>
                    <input type="text" name="theme_options[footer-btn-link]" value="<?php echo esc_attr( $value ); ?>">
                </td>
            </tr>

            <?php // Text input example ?>
            <tr valign="top">
                <th scope="row"><?php esc_html_e( 'Copy Rights', 'text-domain' ); ?></th>
                <td>
                    <?php $value = self::get_theme_option( 'copy_rights' ); ?>
                    <input type="text" name="theme_options[copy_rights]" value="<?php echo esc_attr( $value ); ?>">
                </td>
            </tr>
